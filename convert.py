...
class GregorianToJalali:
    ...
    def __init__(self, gyear, gmonth, gday, gweekday=None):
        """
        ...
        self.gmonth = gmonth
        self.gday = gday
        self.gweekday = gweekday
        self.__gregorianToJalali()

    def getJalaliList(self):
        if self.gweekday == None:
            return {'y': self.jyear, 'm': self.jmonth, 'd': self.jday}
        else:
            return {'y': self.jyear, 'm': self.jmonth, 'd': self.jday, 'w': common.PCAL_NormalizeWeekday(self.gweekday)}
...
class JalaliToGregorian:
    ...
    def getGregorianList(self):
        return {'y': self.gyear, 'm': self.gmonth, 'd': self.gday}
